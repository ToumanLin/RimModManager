  ...
  <div class=" w-full">
    ...
    <div class="relative group flex items-center gap-2 w-full">
      ...
      <button v-if="isPath" @click="$emit('browse')"
        class="shrink-0 p-2.5 bg-bg-overlay/5 hover:bg-accent-primary/20 border border-border-base/10 hover:border-accent-primary/50 rounded-lg text-text-dim hover:text-accent-primary transition-all active:scale-95"
        v-tooltip="'浏览路径'">
