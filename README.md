...
当前项目主要按桌面应用设计，现已包含 Windows 与 macOS 的运行路径。
...
- Node.js 18+
- `uv`
- Windows 上可用的 **WebView2 Runtime**（仅 Windows 桌面模式需要）
...
- Windows 默认输出 `dist/RimModManager.exe`
- macOS 默认输出 `dist/RimModManager.app`
